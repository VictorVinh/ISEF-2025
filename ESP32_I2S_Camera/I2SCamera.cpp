...
bool I2SCamera::initVSync(int pin)
{
  ...
  if(esp_intr_alloc_intrstatus(&vSyncInterrupt, (void*)"vSyncInterrupt", ESP_INTR_FLAG_INTRDISABLED | ESP_INTR_FLAG_IRAM, &vSyncInterruptHandle) != ESP_OK) 
  {
...
bool I2SCamera::init(const gpio_num_t XRES, const gpio_num_t YRES, const gpio_num_t VSYNC, const gpio_num_t HREF, const gpio_num_t XCLK, const gpio_num_t PCLK, const gpio_num_t D0, const gpio_num_t D1, const gpio_num_t D2, const gpio_num_t D3, const gpio_num_t D4, const gpio_num_t D5, const gpio_num_t D6, const gpio_num_t D7)
{
  xres = XRES;
  yres = YRES;
...
bool I2SCamera::i2sInit(const gpio_num_t VSYNC, const gpio_num_t HREF, const gpio_num_t PCLK, const gpio_num_t D0, const gpio_num_t D1, const gpio_num_t D2, const gpio_num_t D3, const gpio_num_t D4, const gpio_num_t D5, const gpio_num_t D6, const gpio_num_t D7)
{    
  gpio_num_t pins[] = {VSYNC, HREF, PCLK, D0, D1, D2, D3, D4, D5, D6, D7};    
  gpio_config_t conf = {
    .pin_bit_mask = 0,
    ...
    gpio_set_direction(D0,    I2S0I_DATA_IN0_IDX, false);
    gpio_set_direction(D1,    I2S0I_DATA_IN1_IDX, false);
    gpio_set_direction(D2,    I2S0I_DATA_IN2_IDX, false);
    gpio_set_direction(D3,    I2S0I_DATA_IN3_IDX, false);
    gpio_set_direction(D4,    I2S0I_DATA_IN4_IDX, false);
    gpio_set_direction(D5,    I2S0I_DATA_IN5_IDX, false);
    gpio_set_direction(D6,    I2S0I_DATA_IN6_IDX, false);
    gpio_set_direction(D7,    I2S0I_DATA_IN7_IDX, false);
    gpio_set_direction(0x30,  I2S0I_DATA_IN8_IDX, false);
    gpio_set_direction(0x30,  I2S0I_DATA_IN9_IDX, false);
    gpio_set_direction(0x30,  I2S0I_DATA_IN10_IDX, false);
    gpio_set_direction(0x30,  I2S0I_DATA_IN11_IDX, false);
    gpio_set_direction(0x30,  I2S0I_DATA_IN12_IDX, false);
    gpio_set_direction(0x30,  I2S0I_DATA_IN13_IDX, false);
    gpio_set_direction(0x30,  I2S0I_DATA_IN14_IDX, false);
    gpio_set_direction(0x30,  I2S0I_DATA_IN15_IDX, false);
        
    gpio_set_direction(VSYNC, I2S0I_V_SYNC_IDX, true);
    gpio_set_direction(0x38,  I2S0I_H_SYNC_IDX, false);  //0x30 sends 0, 0x38 sends 1
    gpio_set_direction(HREF,  I2S0I_H_ENABLE_IDX, false);
    gpio_set_direction(PCLK,  I2S0I_WS_IN_IDX, false);
